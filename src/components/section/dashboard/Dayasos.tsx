            ...
            <div className=" my-12 ">
                ...
                <div className="grid grid-cols-3 gap-5 mt-5">
                    ...
                    <LongCard props={['Rumah Ibadah', 'Persentasi Rumah Ibadah']}>
                        <LongCard.Chart data={[20, 5, 13, 13, 22, 15, 12]} label={['Mesjid', 'Gereja', 'Kuil Hindu', 'Gereja Khatolik', 'Kuil Budha', 'Musholla', 'Kuil Budha']} isPercent={true} backgroundColor={['#F94144', '#F3722C', '#F9C74F', '#90BE6D', '#F8961E', '#2D9CDB', '#DD2153']} />
                    </LongCard>
