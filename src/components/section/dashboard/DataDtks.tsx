            ...
            <div className=" ">
                ...
                <div className="grid grid-cols-3 gap-5 mt-5">
                    <LongCard props={['Data DTKS', 'Persentasi Data DTKS']}>
                        <LongCard.Chart data={[12, 19]} isPercent={true} label={['DTKS', 'Non DTKS']} backgroundColor={['#F94144', '#F3722C']} />
                    </LongCard>
                    <LongCard props={['Jenis Kelamin', 'Persentasi Data DTKS Berdasarkan Jenis Kelamin']}>
                        <LongCard.Chart data={[30, 15]} isPercent={true} label={['Laki-laki', 'Perempuan']} backgroundColor={['#F94144', '#F3722C']} />
                    </LongCard>
