...
const labels = ['Bilal Jenazah', 'Penggali Kubur', 'Nazir Mesjid', 'Nazir Musholla', 'Pengurus Gereja', 'Pengurus Kuil/Klenteng /Vihara', 'Imam Mesjid', 'Khatib Jumat', 'Ustadz', 'Ustadzah', 'Petugas Gereja Katolik', 'Guru Maghrib Mengaji', 'Guru Sekolah Minggu', 'Guru Sekolah Budha', 'Guru Sekolah Hindu', 'Penatua'];
