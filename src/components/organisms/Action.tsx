  ...
  return (
    ...
    <DropdownMenu>
            ...
            <DropdownMenuContent className="mr-5">
                {onEdit ? <DropdownMenuItem className='cursor-pointer'>
                <DropdownMenuLabel className="text-primary" onClick={onEdit}>Edit</DropdownMenuLabel>
              </DropdownMenuItem> : null}
                {onDelete ? <DropdownMenuItem className='cursor-pointer'>
                <DropdownMenuLabel className="text-primary" onClick={onDelete}>
                  Hapus
                </DropdownMenuLabel>
              </DropdownMenuItem> : null}
              {onDetail ? <DropdownMenuItem className='cursor-pointer'>
