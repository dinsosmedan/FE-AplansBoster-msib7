...
import { useGetTuitionAssistanceEventById } from '@/store/server/useService'
...
export default function ModalEditDataBBP({ isShow, setIsShow, tuitionAssistanceId, eventId }: ModalEditDataBBPProps) {
  ...
  const { data, isSuccess } = useGetTuitionAssistanceEventById(tuitionAssistanceId)
  ...
  const onSubmit = (data: FormValuesEditData) => {
    console.log(data)
  }
