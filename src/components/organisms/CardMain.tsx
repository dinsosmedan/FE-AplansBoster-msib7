  ...
  return (
    <div className="w-[385px] bg-primary rounded-lg flex flex-col overflow-hidden group justify-between">
      ...
      <div className="relative overflow-hidden group my-2">
        <img
          className="object-cover w-full h-[180px] py-2 transition-transform transform scale-110 group-hover:scale-150 ease-in-out duration-300 brightness-80 group-hover:brightness-110"
          src={urlImage}
          alt=""
        />
      </div>
