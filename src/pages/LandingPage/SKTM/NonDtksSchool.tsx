...
import { CardLandingPage, Loading, NoData } from '@/components'
import { useGetIndigencyCertificateApplicationPublic } from '@/store/server/usePublic'
import { cn } from '@/lib/utils'
import { BgEmpty } from '@/assets'

export default function NonDtksSchool() {
  const { data, isLoading } = useGetIndigencyCertificateApplicationPublic('non-dtks-schools')
