...
const BansosLansia = () => {
    ...
    return (
        <div className='container bg-white py-5'>
            <div className='w-full text-center'><p className='text-2xl font-bold'>Data Personal</p></div>
            <Form {...forms}>
                <form onSubmit={forms.handleSubmit(onSubmit)} className="flex flex-col gap-6">
                    ...
                    <div className='w-full text-center'><p className='text-2xl font-bold'>Alamat</p></div>
                    <div className='flex flex-row gap-4'>
                        <div className='w-4/12'>
                            <FormField
                                name="no_kk"
                    ...
                    <div className='w-full text-center'><p className='text-2xl font-bold'>Lainnya</p></div>
                    <div>
                        <FormField
                            name="program_bansos"
                            control={forms.control}
