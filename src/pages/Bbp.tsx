          ...
          <div className="flex flex-row gap-4">
            <div className="w-6/12">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold dark:text-white">Nama Mahasiswa</FormLabel>
                    <FormControl>
                      <Input {...field} type="text" placeholder="Masukkan Nama Mahasiswa" />
                    </FormControl>
                  </FormItem>
                )}
              />
          ...
          <div className="flex flex-row gap-4">
            <div className="w-6/12">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-semibold dark:text-white">Kampus</FormLabel>
                    <FormControl>
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        <FormControl>
                          <SelectTrigger>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="text" placeholder="Masukkan IPK " />
                    </FormControl>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input {...field} type="text" placeholder="Masukan Tahun Anggaran" />
                    </FormControl>
                  </FormItem>
                )}
              />
