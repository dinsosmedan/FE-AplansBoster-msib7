...
export const kubeValidation = Yup.object({
  businessName: Yup.string().required('wajib diisi').max(255, 'maksimal 255 karakter'),
  businessType: Yup.string().required('Wajib diisi').max(255, 'maksimal 255 karakter'),
  businessAddress: Yup.string().required('Wajib diisi').max(255, 'Alamat Usaha maksimal 255 karakter'),
  areaLevel3: Yup.string().required('Kecamatan wajib diisi'),
  areaLevel4: Yup.string().required('Kelurahan wajib diisi'),
