...
export const elderlyCashSocialAssistanceValidation = Yup.object({
...
export type elderlyCashSocialAssistanceFields = Yup.InferType<typeof elderlyCashSocialAssistanceValidation>
